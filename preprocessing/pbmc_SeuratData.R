#' Here we take a look at the PBMC Multiome data from 10x Genomics, as part of Seurat data
#' 
#' Follow the vignette/tutorial found in:
...
# Store data for HPC use
pbmcMultiOme_data <- vector("list")
pbmcMultiOme_data$rna <- pbmc.rna
pbmcMultiOme_data$atac <- pbmc.atac
#save(pbmcMultiOme_data, file = "pbmcMultiOme_data.rda")
...
# Identify anchors
pbmc.atac[['ACTIVITY']] <- CreateAssayObject(counts = activity.matrix[, colnames(pbmc.atac)])
